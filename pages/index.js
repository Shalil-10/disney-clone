  ...
  return (
    <div className="">
      ...
      {!session ? (
        ...
        <main className="relative min-h-screen after:bg-home after:bg-cover after:bg-no-repeat after:bg-fixed after:absolute after:inset-0 after:z-[-1]">
          <Slider />
          <Brands />
...
export async function getServerSideProps(context) {               //try commenting n see the delay
  const session = await getSession(context)

  const [popularMoviesRes, popularShowsRes, topRatedMoviesRes, topRatedShowsRes] = await Promise.all([
