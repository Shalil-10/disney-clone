    ...
    <div>
      ...
      {!session ? (
        ...
        <section className="relative z-50">
          ...
          <div className="relative min-h-[calc(100vh-72px)]"> {/*here we set the height of image by subtracting header height (72px) - 100vh. If we don't do it will show scrollbar   */}
            <Image
              src={
          ...
          <div className="absolute inset-y-28 inset-x-4 md:inset-y-auto md:bottom-10 md:inset-x-12 space-y-6 z-50">
